...
namespace Foodiez.Controllers
{
    ...
    {
        public IConfiguration _configuration; private readonly  FoodiezContext _context; public TokenController(IConfiguration config, FoodiezContext context) { _configuration = config; _context = context; }
        [HttpPost]
